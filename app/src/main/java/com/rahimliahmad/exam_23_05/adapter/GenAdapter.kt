...
import com.rahimliahmad.exam_23_05.model.Genre
import com.squareup.picasso.Picasso

class GenAdapter (list : List<Genre>) : RecyclerView.Adapter<Adapter.ViewHolder>() {
    var list : List<Genre>
    init {
        this.list=list
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
     var genre=itemView.findViewById<TextView>(R.id.detail)
    }
